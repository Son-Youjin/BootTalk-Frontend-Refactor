...
const BootcampTagsMobile = ({
  category,
  region,
  capacity,
}: BootcampTagsMobileProps) => {
  return (
    <div className="flex gap-2 flex-wrap md:hidden text-xs mt-2">
      ...
      <span className="badge bg-gray-100 px-3 py-1 rounded-full">
        {capacity}명
      </span>
    </div>
  );
